...
List<Widget> teamMembersList = [
  ...
  OrganiserTile(
    imageUrl:
    'https://scontent.fdel11-1.fna.fbcdn.net/v/t1.0-9/49601302_1996374853788799_8380964671905071104_n.jpg?nc_cat=100&_nc_ohc=53-0RBXMcMAQk6qUDhEFG17CGnvHb2ZLh8Y-6qRqkFBgatMcc-VXQIbQ&_nc_ht=scontent.fdel11-1.fna&oh=8e2f24a52f7c277d8b4e9a25bb5d35d8&oe=5EAFCA47',
    name: 'Muskan Khan',
  ...
  OrganiserTile(
    imageUrl:
    'https://scontent.fdel11-1.fna.fbcdn.net/v/t1.0-9/p960x960/66094392_2330332423892462_368378580473741312_o.jpg?nc_cat=106&_nc_ohc=K0WOsyVexvMAQkcjroVj_rB_b_UPyHNMZpmsz0zaY_kL7LDFFOdDM49A&_nc_ht=scontent.fdel11-1.fna&_nc_tp=1&oh=469ae54dc10ef69bfa5fe451cd856b10&oe=5EA7DC9E',
    name: 'Ayush Shukla',
    designation: 'Registration',
